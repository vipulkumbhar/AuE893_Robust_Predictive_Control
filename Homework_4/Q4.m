...
%% Q3
X_startpoints_all = [-1 1 1 0;-1 1 0 1];
...
for i_s = 1:1
    ...
    U_u_tightened_constraint = input_constraint(1,1:length(N_lin));
    U_l_tightened_constraint = input_constraint(2,1:length(N_lin));
...
lgd = legend('Status [-1 -1]','Status [1 1]','Status [1 0]','Status [0 1]');
