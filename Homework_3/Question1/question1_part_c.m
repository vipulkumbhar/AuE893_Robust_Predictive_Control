%% AuE 893: Robust Predictive Conrtol HW03, Excercise 2.6 part c
...
title('System State Trajectory');grid on
legend({'X1 - State','X1 - Set Point','X2 - State','X2 - Set Point'},'Location','northwest')

% Plot for the control input
figure;stairs(T(1:end-1),u(1,:),'b','Linewidth',2);hold on
stairs(T(1:end-1),u(2,:),'r','Linewidth',2);ylabel('Control Input')
xlabel('Simulation Time in seconds');title('System Control Input')
...
xlabel('Simulation Time in seconds');ylabel('Outputs');grid on
